package com.example.aanandam.Common;
...
public class Common {
    ...
    public static String Currentpatientimage ;
    public static String Currentdoactorimage ;
    public static  String CurrentUserName;
    public static  String Currentpatientuserid = "";
    ...
    public static String CurrentppatientPhone = "062912361255";
